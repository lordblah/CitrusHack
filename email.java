...
public class emergencyContactEmail extends HttpServlet{
	public void doGet(HttpServletRequest request,
		...
		try{
			...
			//actual HTML message
			message.setContent("<h1 style="text-align: center; font-style:Times 

New Roman">Listen, empathise, and don’t judge</h1>,
    <p>The web browsing activity of your family member show signs of falling back into a 

relapse of depression. Please take time out of your day to listen to them actively, 

empathise and don't judge.</p>","text/html");
